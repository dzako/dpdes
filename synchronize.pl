...
copy("DPDEContainerTest.cpp", $path."DPDEContainerTest.cpp") or die "File cannot be copied.";
...
copy("doc.html", "../capd_dynsys_dPDEs/doc.html") or die "File cannot be copied.";
