...
//  u_0[dpde.mode2array(idx, 0)] = Interval(0.000331914)+r;
  ...
  u_0[idx].im = Interval(0.350668)+r;
  idx[0] = 4;
  u_0[idx].im = Interval(-2.27674)+r2;
  idx[0] = 5;
  u_0[idx].im = Interval(-1.11533)+r2;
  idx[0] = 6;
  u_0[idx].im = Interval(-0.369307)+r2;
  idx[0] = 7;
  u_0[idx].im = Interval(0.460388)+r2;
  idx[0] = 8;
  u_0[idx].im = Interval(-0.460455)+r2;
  idx[0] = 9;
  u_0[idx].im = Interval(-0.311502)+r2;
  idx[0] = 10;
  u_0[idx].im = Interval(-0.14496)+r2;
  idx[0] = 11;
  u_0[idx].im = Interval(0.0510489)+r2;
  idx[0] = 12;
  u_0[idx].im = Interval(-0.021659)+r2;
  idx[0] = 13;
  u_0[idx].im = Interval(-0.0341329)+r2;
  idx[0] = 14;
  u_0[idx].im = Interval(-0.0261352)+r2;
  idx[0] = 15;
  u_0[idx].im = Interval(0.00130753)+r2;
  idx[0] = 16;
  u_0[idx].im = Interval(8.74462e-005)+r2;
  idx[0] = 17;
  u_0[idx].im = Interval(-0.00211553)+r2;
  idx[0] = 18;
  u_0[idx].im = Interval(-0.00289166)+r2;
  idx[0] = 19;
  u_0[idx].im = Interval(-0.000500848)+r2;
  idx[0] = 20;
  u_0[idx].im = Interval(3.35395e-005)+r2;
  idx[0] = 21;
  u_0[idx].im = Interval(-4.42524e-005)+r2;
  idx[0] = 22;
  u_0[idx].im = Interval(-0.000228317)+r2; 
  idx[0] = 23;
  u_0[idx].im = Interval(-9.03847e-005)+r2;
  u_0[24] = -8.072115e-05 + r2;// 1.308558e-04*unit;   
  u_0[25] = 4.061472e-08 + r2;// 9.198090e-05*unit;   
  u_0[26] = -1.771179e-05 + r2;//3.554454e-05*unit; 
  u_0[27] = 2.160790e-08 + r2;//2.349743e-05*unit;
  u_0[28] = -7.683240e-06 + r2;//1.260077e-05*unit;   
  u_0[29] = 2.596207e-08 + r2;//9.292410e-06*unit;
  u_0[30] = -2.010571e-06 + r2;//3.919528e-06*unit;
  u_0[31] = 6.457350e-10 + r2;//2.345435e-06*unit;
  u_0[32] = -6.027532e-07 + r2;//1.234009e-06*unit;
  u_0[33] = -1.827155e-10 + r2;//9.444884e-07*unit;
  u_0[34] = -1.912217e-07 + r2;//4.313323e-07*unit;
  u_0[35] = 3.132762e-10 + r2;//2.868533e-07*unit;
  u_0[36] = -4.913630e-08 + r2;//1.266784e-07*unit;
  u_0[37] = -9.639931e-11 + r2;//8.683696e-08*unit;
  u_0[38] = -1.765817e-08 + r2;//4.377705e-08*unit;
  u_0[39] = 5.956034e-11 + r2;//2.952584e-08*unit;
  u_0[40] = -4.319419e-09 + r2;//1.356505e-08*unit;
  u_0[41] = -5.973398e-13 + r2;//8.370721e-09*unit;
  u_0[42] = -1.504751e-09 + r2;//4.220192e-09*unit;
  u_0[43] = 1.344236e-12 + r2;//2.861523e-09*unit;
  u_0[44] = -3.968956e-10 + r2;//1.380749e-09*unit;  
  u_0[45] = 1.644704e-12 + r2;//8.409932e-10*unit;
  u_0[46] = -1.194526e-10 + r2;//4.089145e-10*unit;
  u_0[47] = 5.600085e-14 + r2;//2.657488e-10*unit;
  u_0[48] = -3.735948e-11 + r2;//1.302601e-10*unit;
  u_0[49] = 6.923386e-14 + r2;//8.303362e-11*unit;
  u_0[50] = -1.115027e-11 + r2;//3.944118e-11*unit;
  u_0[51] = 7.625038e-15 + r2;//2.587359e-11*unit;
  u_0[52] = -3.235955e-12 + r2;//1.367747e-11*unit;
  u_0[53] = 5.355447e-15 + r2;//9.556918e-12*unit;
  u_0[54] = -8.851600e-13 + r2;//6.710554e-12*unit;
  u_0[55] = 8.157066e-15 + r2;//7.432209e-12*unit;
  u_0[56] = -2.575738e-13 + r2;//1.124376e-11*unit;
  u_0[57] = -1.227735e-14 + r2;//1.289762e-11*unit;
  u_0[58] = -7.847187e-14 + r2;//2.020907e-11*unit;
  u_0[59] = -9.994174e-16 + r2;//2.716484e-11*unit;
  u_0[60] = -2.302107e-14 + r2;//5.846583e-11*unit;
  u_0[61] = -1.752133e-15 + r2;//7.916104e-11*unit;
  u_0[62] = -6.511992e-15 + r2;//1.314991e-10*unit;
  u_0[63] = -3.185013e-16 + r2;//1.656574e-10*unit;
  u_0[64] = -1.860478e-15 + r2;//2.432627e-10*unit;
  u_0[65] = 1.817169e-16 + r2;//3.177145e-10*unit;
  u_0[66] = -5.958659e-16 + r2;//4.635467e-10*unit;
  u_0[67] = -3.186116e-17 + r2;//4.507650e-10*unit;
  u_0[68] = -1.644389e-16 + r2;//3.785445e-10*unit;
  u_0[69] = -8.100358e-18 + r2;//3.550455e-10*unit;
  u_0.setToRealValuedOdd();
  setC(u_0, 5.039534e+7);
  setS(u_0, 8);
